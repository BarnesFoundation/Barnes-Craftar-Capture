...
class ImageService {
    ...
    constructor() {
        this.httpConfig = {
            url: Config.managementApiUrl + Config.imageRoute + '/?api_key=' + Config.managementApiKey,
    ...
    private parseImageCreateResponse(response: ImageCreateResponse): CreateResponse {
