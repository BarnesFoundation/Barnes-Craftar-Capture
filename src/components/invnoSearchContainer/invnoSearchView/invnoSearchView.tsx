...
class InvnoSearchView extends React.Component<Props> {
  ...
  public render() {
    ...
    const displayText = "Searching for the Invno";

    const itemSearchForm = (
      <InvnoSearchForm handleSubmit={this.props.handleSubmit}></InvnoSearchForm>
    );
    const setItemButton = (
      <Button variant="contained" onClick={this.props.setSearchedItem}>
        Set item
      </Button>
    );
